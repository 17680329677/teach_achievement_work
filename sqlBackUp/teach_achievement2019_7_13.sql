...
CREATE TABLE `book` (
  ...
  `book_number` varchar(255) DEFAULT NULL COMMENT '教材编号（展示）鉴于部分数据ISBN丢失，因此系统需自动生成论文编号',
  `publish_year_month` bigint(20) DEFAULT NULL COMMENT '出版时间',
  ...
  `participate_teacher` varchar(255) DEFAULT NULL COMMENT '作者【参与教师（多个）】，教师工号用英文逗号隔开',
  `submit_teacher` varchar(255) DEFAULT NULL COMMENT '提交教师（工号）',
  `submit_time` bigint(20) DEFAULT NULL COMMENT '提交时间（展示）',
  `status` varchar(255) DEFAULT NULL COMMENT '状态【用户：1.未提交/2.已提交/3.已存档    管理员：2.待存档/3.已存档】',
...
-- Records of book
-- ----------------------------
INSERT INTO `book` VALUES ('2', '计算机网络安全基础（第5版）', '9787115476210', '201802', '283', '52', '9787115476210', '人民邮电出版社', '5', '质教材', '7', '100110', null, 'fa71e137-b339-4b70-89cf-8b6a2ac8f685.jpg', '', '78fc2350-9cf6-4e91-bb7f-ca34b963352a.jpg', null, '654654', null, '3', '1');
...
CREATE TABLE `invigilate_info` (
  ...
  `submit_time` bigint(20) NOT NULL COMMENT '提交时间',
  `college_id` int(11) NOT NULL COMMENT '所属学院id',
  `status` varchar(80) DEFAULT NULL COMMENT '状态【用户：1.未提交/2.已提交/3.已存档    管理员：2.待存档/3.已存档】',
  `using` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
INSERT INTO `teacher_book` VALUES ('1', '654654', '2', '1', '1');
...
INSERT INTO `teacher_info` VALUES ('8', '670103', '陈志泊', '男', '汉族', '-94723200000', '100110', '26', '5', '30', '1', '是', '5', null, '1', '博士', '1', '', '北京林业大学', '计算机应用', '13910400825', 'zhibo@bjfu.edu.cn', '在职', '1');
INSERT INTO `teacher_info` VALUES ('12', '650909', '黄心渊', '男', '汉族', '1', '100110', '0', '3', '27', '1', '是', '5', null, null, '博士', null, null, null, null, null, null, '在职', '1');
INSERT INTO `teacher_info` VALUES ('13', '550401', '吴保国', '男', '汉族', '1', '100110', '28', '4', '27', '1', '是', '5', null, null, '本科', '1982', null, '北京林业大学', '森林经理学/林业信息管理', '13621224251', 'wubg@bjfu.edu.cn', '在职', '1');
INSERT INTO `teacher_info` VALUES ('14', '610202', '赵天忠', '男', '汉族', '1', '100110', '28', '5', '39', '1', '否', '5', null, null, '博士', null, null, '北京林业大学', '资源信息管理/企业信息管理', '13601108182', 'ztz@bjfu.edu.cn', '在职', '1');
INSERT INTO `teacher_info` VALUES ('15', '536656', '王春玲', '女', '汉族', '1', '100110', '26', '6', '39', '1', '否', '5', null, null, '博士', '131346546513', null, null, null, '13910400825', 'wcl@bjfu.edu.cn', '在职', '1');
INSERT INTO `teacher_info` VALUES ('16', '654654', '齐建东', '男', '汉族', '1', '100110', '30', '8', '39', '1', '否', '5', null, null, '博士', null, null, '中国农业大学', null, '', 'qijd@bjfu.edu.cn', '在职', '1');
INSERT INTO `teacher_info` VALUES ('17', '551232', '淮永建', '男', '汉族', '1', '100110', '29', '5', '39', '1', '否', '5', null, null, '博士', null, null, null, null, null, 'hyj@bjfu.edu.cn', '在职', '1');
INSERT INTO `teacher_info` VALUES ('18', '654652', '李昀', '男', '汉族', '1', '100110', '28', '7', '39', '1', '否', '5', null, null, '博士', null, null, null, null, null, '@bjfu.edu.cn', '在职', '1');
INSERT INTO `teacher_info` VALUES ('19', '654655', '韩静华', null, '汉族', '1', '100110', '0', '6', '39', '1', '否', '5', null, null, '博士', null, null, null, null, null, '@bjfu.edu.cn', '在职', '1');
INSERT INTO `teacher_info` VALUES ('20', '461232', '郑云', null, '汉族', '1', '100110', '31', '5', '39', '1', '否', '5', null, null, '博士', null, null, null, null, null, '@bjfu.edu.cn', '在职', '1');
INSERT INTO `teacher_info` VALUES ('21', '654654', '郭小平', null, '汉族', '1', '100110', '32', '6', '39', '1', '否', '5', null, null, '博士', null, null, null, null, null, '@bjfu.edu.cn', '在职', '1');
...
CREATE TABLE `teach_reform_paper` (
  ...
  `college_id` int(11) DEFAULT NULL COMMENT '所属学院id',
  `status` varchar(40) DEFAULT NULL COMMENT '状态【用户：1.未提交/2.已提交/3.已存档    管理员：2.待存档/3.已存档】',
  `using` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `title_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `datetime` datetime NOT NULL COMMENT '任职变更时间',
