...
'''
    3.挂载 教师职称选项
'''
@cadmin.route('/teacher_title_option/get',methods=['GET','POST'])
...
'''
@cadmin.route('/teacher_info_number_name/get',methods=['GET','POST'])
...
'''
    ...
    :return   number  name  department_id
'''
@cadmin.route('/teacher_info_number_name/get_by_department_id',methods=['GET','POST'])
